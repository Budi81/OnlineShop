...
namespace OnlineShop.BusinessLayer
{
    public class SqlDb : IDatabase
    {
        ...
        {
            string addOrderCommand =
                $@"INSERT INTO [dbo].[Orders] (CustomerId, AmountToPay, DateOfOrder, Status) " +
            ...
            {
                string addOrderProduct =
                    $@"INSERT INTO [dbo].[OrderProduct] (OrderId, ProductId, Count) " +
        ...
        {
            string addProduct =
                "INSERT INTO [dbo].[Products] (ProductName, ProductPrice, Stock) " +
        ...
        public void DeleteCustomer(Customer customer)
        {
            string deleteCustomer =
                $@"DELETE FROM [dbo].[Customers] WHERE CustomerId ='{customer.CustomerId}'";
        ...
        {
            string deleteOrder =
                $@"DELETE FROM [dbo].[Orders] WHERE id ='{order.OrderId}'";
            ...
            string deleteOrderProduct =
                $@"DELETE FROM [dbo].[OrderProduct] WHERE OrderId ='{order.OrderId}'";
        ...
        public List<Customer> GetAllCustomers()
        {
            string getAllCustomers =
                @"SELECT CustomerId, FirstName, LastName, Adress, Email, Password FROM [dbo].[Customers]";
        ...
        public List<Product> GetAllProducts()
        {
            string getAllProducts =
                @"SELECT ProductId, ProductName, ProductPrice, Stock, Type from [dbo].[Products]";
        ...
        {
            string getCustomer =
                $@"SELECT id, CustomerId, AmountToPay, DateOfOrder, Status FROM [dbo].[Orders] WHERE id='{orderId}'";
        ...
        private Dictionary<Product, int> GetOrderProducts(int orderId)
        {
            string getOrderProducts =
                $@"SELECT Id, ProductId, Count FROM [dbo].[OrderProduct] WHERE OrderId='{orderId}'";
        ...
        {
            string getOrderProducts =
                $@"SELECT Name, Value FROM [dbo].[ProductAttributes] WHERE ProductId='{productId}'";
